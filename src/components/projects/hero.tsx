      ...
      >
        ...
        <div className="space-y-12">
          <div>
            ...
            <h1 className="xl:text-[128px] lg:text-[96px] md:text-[80px] animate-item text-[64px] font-display font-black leading-none ">
              WORK <br />
          ...
          <div className="w-full flex md:flex-row flex-col gap-2 justify-between">
            <p className="text-secondary-foreground font-mono text-md md:max-w-1/2 max-w-full animate-item">
              Frontend & Fullstack Developer crafting minimal digital
              architectures through code and precision.
            </p>
            <div className="flex justify-between">
              <div className="flex flex-col gap-2 md:items-end items-start animate-item">
